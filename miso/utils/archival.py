...
from miso.models.model import Model, _DEFAULT_WEIGHTS
...
def load_archive(archive_file: str,
                 ...
                 embedding_file: str = None) -> Archive:
    """
    ...
    if embedding_file:
        config["model"]["lm_file"] = embedding_file
        config["model"]["test_lm_file"] = embedding_file
