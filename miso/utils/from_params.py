...
class FromParams:
    ...
    def from_params(cls: Type[T], params: Params, **extras) -> T:
        ...
        from miso.utils.registrable import Registrable  # import here to avoid circular imports
        ...
        if registered_subclasses is not None:
            ...
            # this line is changed from the original version
            choice = params.pop("type")
            # params.pop_choice("type",
