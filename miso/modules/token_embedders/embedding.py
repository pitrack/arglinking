...
from miso.utils.file import get_file_extension, cached_path
from miso.data import Vocabulary
...
class Embedding(TokenEmbedder):
    ...
    :class:`~miso.data.fields.TextField`, you should use a
    :class:`~miso.modules.TextFieldEmbedder` instead of using this directly.
