...
from miso.utils.archival import CONFIG_NAME, _DEFAULT_WEIGHTS, archive_model
from miso.commands.evaluate import evaluate
from miso.metrics import dump_metrics
...
def train_model(params: Params):
    ...
    FINETUNE = params['trainer']['finetune']
    if FINETUNE:
        vocab = Vocabulary.from_params(params=vocab_params, instances=train_data)
    else:
    ...
    if test_data and evaluate_on_test:
        ...
        test_metrics = evaluate(best_model, test_data, test_iterator, device)
